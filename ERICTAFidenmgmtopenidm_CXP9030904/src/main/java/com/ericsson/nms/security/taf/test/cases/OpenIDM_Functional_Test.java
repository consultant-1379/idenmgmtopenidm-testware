...
public class OpenIDM_Functional_Test extends TorTestCaseHelper implements TestCase {
    ...
    @DataDriven(name = "OpenIDM_ST_Test_Data")
    ...
    /**
     * @DESCRIPTION Create a new valid user In openIDM
     * @PRE SC node has been installed with LITP and TOR security OpenIDM Package
     * @PRIORITY HIGH
     */
    @TestStep(id = "createInvalidUser")
    @TestId(id = "TORF-9567_Func_21_Invalid", title = "Verify create a new invalid user")
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance" })
    @DataDriven(name = "OpenIDM_Create_New_Invalid_User")
    public void verifyCreateANewInvalidUser(@Input("step") String step, @Input("host") String hostname, @Input("command") String command,
    		@Input("timeout") int timeout, @Input("args") String args, @Output("expectedOut") String expectedOut,
    		@Output("expectedExit") int expectedExitCode) throws InterruptedException, TimeoutException {
    	
    	createUser(step, hostname, command, timeout, args, expectedOut, expectedExitCode);
    }

    /**
     * @DESCRIPTION Create a new invalid user In openIDM
     * @PRE SC node has been installed with LITP and TOR security OpenIDM Package
     * @PRIORITY HIGH
     */
    @TestStep(id = "createValidUser")
    @TestId(id = "TORF-9567_Func_21_Valid", title = "Verify create a new valid user")
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance", "RFA" })
    @DataDriven(name = "OpenIDM_Create_New_Valid_User")
    public void verifyCreateANewValidUser(@Input("step") String step, @Input("host") String hostname, @Input("command") String command,
                                     @Input("timeout") int timeout, @Input("args") String args, @Output("expectedOut") String expectedOut,
                                     @Output("expectedExit") int expectedExitCode) throws InterruptedException, TimeoutException {
	...
	private void createUser(String step, String hostname, String command, int timeout, String args, String expectedOut, int expectedExitCode) throws InterruptedException {
		logger.info("Test Step: " + step);
        cliOperator.initializeShell(hostname);
    ...
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance" })
    @DataDriven(name = "OpenIDM_Query_Existing_User")
     ...
     * @PRIORITY HIGH
     */
    @TestId(id = "TORF-19854-19855", title = "Force user password change")
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance" })
    @DataDriven(name = "OpenIDM_Force_User_Password_Change")
    public void verifyForceUserPasswordChange(@Input("step") String step, @Input("host") String hostname, @Input("command") String command,
                                          @Input("timeout") int timeout, @Input("args") String args, @Output("expectedOut") String expectedOut,
                                          @Output("expectedExit") int expectedExitCode) throws InterruptedException, TimeoutException {
        runCommands(step, hostname, command, timeout, args, expectedOut, expectedExitCode);
    }
    ...
    /**
     * @DESCRIPTION Edit user information with invalid attributes
     * @PRE SC node has been installed with LITP and TOR security OpenIDM Package
     * @PRIORITY HIGH
     */
    @TestId(id = "TORF-9567_Func_23_Invalid", title = "Verify edit user information with invalid attributes")
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance" })
    @DataDriven(name = "OpenIDM_Edit_Existing_User_Invalid_Attr")
    public void verifyEditUserInformationInvalidAttr(@Input("step") String step, @Input("host") String hostname, @Input("command") String command,
    		@Input("timeout") int timeout, @Input("args") String args, @Output("expectedOut") String expectedOut,
    ...
    /**
     * @DESCRIPTION Edit user information with valid attributes
     * @PRE SC node has been installed with LITP and TOR security OpenIDM Package
     * @PRIORITY HIGH
     */
    @TestId(id = "TORF-9567_Func_23_Valid", title = "Verify edit user information with valid attributes")
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance", "RFA" })
    @DataDriven(name = "OpenIDM_Edit_Existing_User_Valid_Attr")
    public void verifyEditUserInformationValidAttr(@Input("step") String step, @Input("host") String hostname, @Input("command") String command,
                                          @Input("timeout") int timeout, @Input("args") String args, @Output("expectedOut") String expectedOut,
                                          @Output("expectedOutCode") int expectedOutCode,
                                          @Output("expectedExit") int expectedExitCode) throws InterruptedException, TimeoutException {
        runCommandsWithExitCode(step, hostname, command, timeout, args, expectedOut, expectedOutCode, expectedExitCode);
    ...
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance", "RFA" })
    @DataDriven(name = "OpenIDM_Delete_Existing_User")
    ...
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance" })
    @DataDriven(name = "OpenIDM_Create_New_Role")
    ...
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance" })
    @DataDriven(name = "OpenIDM_Query_Existing_Role")
    ...
    /**
     * @DESCRIPTION Verify edit role information
     * @PRE SC node has been installed with LITP and TOR security OpenIDM Package
     * @PRIORITY HIGH
     */
    @TestId(id = "TORF-16119_Func_3", title = "Verify editing role information")
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance", "RFA" })
    @DataDriven(name = "OpenIDM_Edit_Existing_Role")
    public void verifyEditRoleInformation(@Input("step") String step, @Input("host") String hostname, @Input("command") String command,
                                          @Input("timeout") int timeout, @Input("args") String args, @Output("expectedOutCode") int expectedOutCode,
                                          @Output("expectedExit") int expectedExitCode) throws InterruptedException, TimeoutException {
        runCommandsWithExitCode(step, hostname, command, timeout, args, expectedOutCode, expectedExitCode);
    }
    ...
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance" })
    @DataDriven(name = "OpenIDM_Query_All_Role_Data")
    ...
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance" })
    @DataDriven(name = "OpenIDM_Query_Default_ENM_Role_User")
    ...
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance" })
    @DataDriven(name = "OpenIDM_Last_Login_Time")
    ...
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance", "RFA" })
    @DataDriven(name = "OpenIDM_FIELD_TECHNICIAN_Role")
    ...
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance" })
    @DataDriven(name = "OpenIDM_User_Password_Change")
     ...
     * @PRIORITY HIGH
     */
    @TestId(id = "TORF-16119_Func_4", title = "Verify role cannot be deleted")
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance" })
    @DataDriven(name = "OpenIDM_Delete_Existing_Role")
    public void verifyDeleteARole(@Input("step") String step, @Input("host") String hostname, @Input("command") String command,
                                  @Input("timeout") int timeout, @Input("args") String args, @Output("expectedOut") String expectedOut,
                                  @Output("expectedOutCode") int expectedOutCode, @Output("expectedExit") int expectedExitCode)
            throws InterruptedException, TimeoutException {
        runCommands(step, hostname, command, timeout, args, expectedOut, expectedExitCode);
    ...
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance" })
    @DataDriven(name = "Create_App_Roles_Test_Data")
    ...
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance" })
    @DataDriven(name = "OpenIDM_Replication")
    ...
    @Context(context = { Context.CLI })
    @Test(groups = { "Acceptance" })
    @DataDriven(name = "OpenIDM_Retrieve_Password_policy")
